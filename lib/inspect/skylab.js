...
/*jslint vars: true, plusplus: true, devel: true, browser: true, nomen: true, indent: 4, maxerr: 50, bitwise: true */
...
define(function (require, exports, module) {
    ...
    function ASLConnection() {
            ...
            var messageActionMap = {
                ...
                'pair_ready' : function () {
                    try {
                        ...
                        SkyLab._dmmsgversion = parseInt(message.version, 0);
                    } catch (ex) {
                ...
                'auth_pending' : function () {
                    SkyLab._dmhandshake = true;
                    SkyLabController.getShowDMHandshake();
                },
                'connect_ok' : function () {
                    SkyLab._dmhandshake = false;
                    SkyLabController.stopShowingMessage('dmhandshake');
                    SkyLabController.stopShowingMessage('dmhandshakerejected');
                ...
                'not_authorized' : function () {
                    SkyLabController.stopShowingMessage('dmhandshake');
                    SkyLab._dmhandshakerejected = true;
                    Connection.giveUpAndStopTrying = true;
                    Connection.disconnect();
                    SkyLabView.triggerDeviceManagerAuthFail();
                }
            };
            try {
        ...
        this.pair = function () {
            if (Connection._dmfirstrun) {
                ...
                // If we don't set this back to false, it will send a pairFirst for the whole session.
                Connection._dmfirstrun = false;
            } else {
        ...
        this.send = function (message) {
            ...
            if (this._isconnected) {
                ...
                d = new Date();
                StorageManager.log(JSON.stringify({"cant send" :  d.toDateString() + " " + d.toLocaleTimeString() + "." + d.getMilliseconds(), "payload" : JSON.parse(message)}));
            }
        };
        ...
        this.message = function (payload) {
            ...
            try {
                ...
                if (payload.action === "remoteinspect") {
                    this.sendWithoutLogging(this.encrypt(this._formatRemoteInspection(payload.options.url, payload.options.device, payload.options.remoteinspect, payload.options.fullscreen)));
                }
        ...
        this._formatPairFirst = function () {
            return JSON.stringify({
                ...
                "options" : {
                    "id": this._uuid,
                    "name" : "Edge Inspect CC Chrome Extension",
                    "type": "administrator",
        ...
        this._formatRemoteInspection = function (url, device, server, fullscreen) {
            return JSON.stringify({
                "action" : "publish",
                "source" : this._uuid,
                "options" : {
    ...
    function ASLSkyLab() {
        ...
        this._dmupdate              = false;
        this._dmhandshake           = false;
        this._dmhandshakerejected   = false;
        ...
        this.remoteInspect = function (device, server, fullscreen) {
            var retval = Connection.message({'action' : 'remoteinspect', 'options' : {'url': this._url, 'device' : device, 'remoteinspect' : server, 'fullscreen' : fullscreen}});
            SkyLabView.triggerRemoteInspect(device, server);
            return retval;
        };
        ...
        this.setDeviceList = function (deviceList) {
            var newDevices = [],
                ...
                today = new Date(),
                // fullscreen = (chrome.extension.getBackgroundPage().isFullScreen) ? "true" : "false";
                fullscreen = "false";
        ...
        this.triggerDeviceManagerError = function () {
            ...
            //SKyLabController.stopShowingMessage('dmupdate');
        ...
        this.getDeviceManagerInfo = function () {
            return {"hostname" : SkyLab._hostname, "hostips" : SkyLab._hostips, "hostport" : SkyLab._hostport, "machinename" : SkyLab._machinename, "build" : SkyLab._dmversion, "dmupdate" : SkyLab._dmupdate};
        };
        ...
        this.setDeviceManagerInfo = function (options) {
            ...
            if (SkyLab._dmversion > '1.0.372.397976') {
                SkyLab._dmupdate = false;
            } else {
                SkyLab._dmupdate = true;
            }
        ...
        this.getRemoteInspectionServer = function () {
            if (SkyLab.getCustomRemoteInspectionServer()) {
                return SkyLab.getCustomRemoteInspectionServer();
            } else {
                return SkyLabView.getRemoteInspectionServer();
            }
        };
        ...
        this.dismissDMUpdate = function () {
            SkyLab._dmupdate = false;
        };
        
        this.dismissDMHandshake = function () {
            SkyLab._dmhandshake = false;
        };
        ...
        this.getShowDMUpdate = function () {
            return SkyLab._dmupdate;
        };
            
        this.getShowDMHandshake = function () {
            return SkyLab._dmhandshake;
        };
            
        this.getShowDMHandshakeRejected = function () {
            return SkyLab._dmhandshakerejected;
        };
            
        this.showWhichMessage = function () {
            // Which messages are the most important to show first.
            var returnvalue = [];
            if (this.getShowDMUpdate()) {
                returnvalue.push('dmupdate');
            }
            ...
            if (this.getShowDMHandshake()) {
                returnvalue.push('dmhandshake');
            }
            if (this.getShowDMHandshakeRejected()) {
                returnvalue.push('dmhandshakerejected');
            }
            return returnvalue;
        };
        ...
        this.stopShowingMessage = function (msgtype) {
            ...
            if (msgtype === 'dmupdate') {
                SkyLab._dmupdate = false;
                //SkyLabController.dismissDMUpdate();
            }
            
            if (msgtype === 'dmhandshake') {
                SkyLab._dmhandshake = false;
            }
    
            if (msgtype === 'dmhandshakerejected') {
                SkyLab._dmhandshakerejected = false;
            }
        ...
        this.setCustomRemoteInspectionServer = function (riserver) {
            return StorageManager.put('customri', riserver);
        };
        
        this.getCustomRemoteInspectionServer = function () {
            return StorageManager.get('customri');
        };
        
        this.unsetCustomRemoteInspectionServer = function () {
            return StorageManager["delete"]('customri');
        };
            ...
            for (errorcode in errors) {
                if (errors.hasOwnProperty(errorcode)) {
                    try {
                        ...
                        // Pitch this to SL Controller
                        SkyLabController.debug('Unknown Preferences Error Code: ' + errorcode);
                    }
                }
            }
            return;
        ...
        this.isFeatureEnabled = function (feature) {
            return (SkyLab._subscriptionfeatures.hasOwnProperty(feature) && SkyLab._subscriptionfeatures[feature]);
        };
    
        this.retryAuthorization = function () {
            SkyLabController.stopShowingMessage('dmhandshakerejected');
            Connection.giveUpAndStopTrying = false;
            Connection.connect();
        };
            
        this.wasTheHandshakeRejected = function () {
            return SkyLab._dmhandshakerejected;
        };
    }
    ...
    function ASLSkyLabController(view) {
        ...
        this.remoteInspect = function (device, server, fullscreen) {
            return SkyLab.remoteInspect(device, server, fullscreen);
        };
        ...
        this.getRemoteInspectionServer = function () {
            return SkyLab.getRemoteInspectionServer();
        };
        ...
        this.dismissDMUpdate = function () {
            return SkyLab._dmupdate;
            //return SkyLab.dismissDMUpdate();
        };
        
        this.dismissDMHandshake = function () {
            return SkyLab._dmhandshaake;
        };
        ...
        this.setCustomRemoteInspectionServer = function (riserver) {
            return SkyLab.setCustomRemoteInspectionServer(riserver);
        };
        ...
        this.unsetCustomRemoteInspectionServer = function () {
            return SkyLab.unsetCustomRemoteInspectionServer();
        };
        ...
        this.retryAuthorization = function () {
            return SkyLab.retryAuthorization();
        };
        this.wasTheHandshakeRejected = function () {
            return SkyLab.wasTheHandshakeRejected();
        };
        
        this.getShowDMHandshake = function () {
            return SkyLab.getShowDMHandshake();
        };
    }
    ...
    function ASLSkyLabView() {
        ...
        this._remoteInspectionServer = "http://debug.edgeinspect.adobe.com/";
        ...
        this.getRemoteInspectionServer = function () {
            return this._remoteInspectionServer;
        };
