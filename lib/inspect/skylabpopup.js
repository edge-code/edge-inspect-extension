...
define(function (require, exports, module) {
    ...
    function showDeviceManagerError() {
        ...
        // these click events were causing popups to close
    ...
    function initInspect($viewEl, _Strings) {
        ...
        var urlHandler = function (url) {
            return function () {
                // Hide the menu whenever opening a URL
                $mainContainer.find("#submenuoverlay").hide();
                openURL(url);
            };
        };
        $mainContainer.find('#renewlink').on('click', function () {
            urlHandler('http://adobe.com/go/edgeinspect_upgrade' + goUrlSuffix)();
        });
        ...
        $mainContainer.find('#showhowto').on('click', function (event) {
            // Hide the menu whenever opening a URL
            $mainContainer.find("#submenuoverlay").hide();
            // display the Getting Started Dialog.
            inspect.showHowToDialog();
        });
        ...
        $(SkyLabController).on("refresh.popup", function (event) {
            refreshDeviceList();
            $mainContainer.trigger("Inspect:refreshCurrentUrl");
        });
        ...
        $(SkyLabController).on("close.popup", function (event) {
            $mainContainer.find("#submenuoverlay").hide();
            $mainContainer.find("#removepanel").hide();
            $mainContainer.find("#mainpanel").show();
        });
        ...
        $mainContainer.find("#logo").click(function (ev) {
            // don't display the menu if we're currently showing the Getting Started dialog
            if (!inspect.isShowingHowToDialog()) {
