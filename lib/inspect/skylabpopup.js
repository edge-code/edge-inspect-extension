...
/*global define: false, $: false, _: false, Backbone: false */
...
//        Strings = require("localized/strings");
    ...
    function getEdgeLocalized(str) {
        //return str;
        if (str === '@@ui_locale') {
            return null; //reflowShell.app.getCurrentLanguage();
        }
    ...
    function setToggleModeImage() {
        ...
        if (SkyLabController.getFollowMode() === "on") {
            ...
            console.log(SkyLabController.isDeviceManagerAlive());
            if (SkyLabController.isDeviceManagerAlive()) {
    ...
    function showWelcomeMessage() {
        ...
        if (showme.length > 0) {
            ...
            $inspect.trigger("Inspect:redraw");
    ...
    function refreshDeviceList() {
        ...
        EventMap.publish("Inspect:redraw");
    }
...
//            reflowShell.app.openURLInDefaultBrowser(url, function () {});
        };
        ...
        $(SkyLabController).on("followmode.popup", function (event) {
            setToggleModeImage();
            EventMap.publish("Inspect:followtoggle");
        });
